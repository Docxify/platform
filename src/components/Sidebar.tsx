...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { href: '/formbricks/formbricks/products/chat', label: 'Support', icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z' },
    { href: 'https://mintlify.com/docs', label: 'Projects', icon: 'M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10l6 6v10a2 2 0 01-2 2z', external: true },
  ];
